...
INSERT INTO Quantity (QuantityID, QuantityMax, QuantityAvailable) VALUES
  ...
  (66, 900, 900);
/*Sunday Daily Admission Tickets*/
...
INSERT INTO MerchandiseCategory (MerchCatID, MerchCatName) VALUES
  ...
  (7, "DayAdmissionTickets"), (8, "WeekAdmissionTickets"), (9, "DayParkingTickets"), (10, "WeekParkingTickets"),
  (11, "DayCampingTickets");
...
VALUES ("thebigcheese", "$2y$10$Lle9WvZM/rOrGF3IeltFN.O5EC5TqIvptb9HR7pDFe8EtyD0T7fRa", 5), -- Festival Chief
...
INSERT INTO Visitors (UserID, FName, LName, PhoneNumber, Email, DOB, Address, City, StateProvince, Country, PostalCode)
VALUES
  (1, "Ivana", "Knight", "915-9094", "taciti.sociosqu.ad@cubilia.co.uk", "1960-09-04", "Ap #841-6590 Purus St.",
      "Cincinnati", "OH", "USA", "74260"),
  ...
  (32, "Cedric", "Casey", "683-0547", "nec@Cras.edu", "1921-10-03", "1956 Conubia St.", "Bellevue", "NE", "USA",
       "45152"),
  (33, "Maris", "Dejesus", "498-3981", "urna@duiFusce.net", "1967-05-06", "996-9836 Magnis Street", "Jonesboro", "AR",
       "USA", "71965"),
  (34, "Pascale", "Knox", "1-844-455-2260", "consectetuer.rhoncus@rutrummagnaCras.com", "1992-07-31",
       "825-6181 Nec Rd.", "Louisville", "KY", "USA", "95455"),
  (35, "Megan", "Schroeder", "140-7705", "egestas.blandit@ligulaAenean.ca", "1968-02-01", "373-3142 Mi Rd.", "Topeka",
       "KS", "USA", "42462"),
  (36, "Phoebe", "Henderson", "822-0618", "Ut@id.co.uk", "1912-03-24", "1035 Odio. Rd.", "Chicago", "IL", "USA",
       "37731"),
  (37, "Hayfa", "Carroll", "593-4958", "tellus@arcuSed.ca", "1976-04-15", "Ap #680-7263 Massa St.", "Sioux City", "IA",
       "USA", "92650"),
  (38, "Leilani", "Arnold", "1-173-843-7510", "eget.magna@in.edu", "1905-07-10", "915-684 Dolor Av.", "Kansas City",
       "MO", "USA", "45198"),
  (39, "Jared", "Kirk", "854-8609", "Duis@placeratvelitQuisque.ca", "1944-08-30", "2038 Risus. Avenue",
       "Salt Lake City", "UT", "USA", "58905"),
  (40, "Nichole", "Pearson", "679-0807", "penatibus@Donecluctusaliquet.edu", "1930-08-25", "1433 Odio. Road",
       "Chesapeake", "VA", "USA", "24340");

INSERT INTO Camping (CampingID)
VALUES ("A01"), ("A02"), ("A03"), ("A04"), ("A05"), ("A06"), ("A07"), ("A08"), ("A09"), ("A10"), ("B01"), ("B02"),
  ("B03"), ("B04"), ("B05"), ("B06"), ("B07"), ("B08"), ("B09"), ("B10"),
  ("C01"), ("C02"), ("C03"), ("C04"), ("C05"), ("C06"), ("C07"), ("C08"), ("C09"), ("C10"), ("D01"), ("D02"), ("D03"),
  ("D04"), ("D05"), ("D06"), ("D07"), ("D08"), ("D09"), ("D10"), ("E01"), ("E02"), ("E03"), ("E04"), ("E05"),
  ("E06"), ("E07"), ("E08"), ("E09"), ("E10");
...
INSERT INTO VendorCategory (VendCatName)
VALUES ("Apparel"), ("Instruments"), ("Books"), ("Repair"), ("Body Art"), ("Entertainment Media"), ("Misc"), ("Food");

INSERT INTO VendorAssignment (SectionID, VendorName, Description, VisitorID, VendCatID) VALUES
  ("A01", "Accordion City Mega Mall", "Instrument store", 11, 2),
  ("A02", "Accordion City Mega Mall", "Instrument store", 11, 2),
  ("A03", "Accordion City Mega Mall", "Instrument store", 11, 2),
  ("A04", "Accordion City Mega Mall", "Instrument store", 11, 2),
  ("A05", "Accordion City Mega Mall", "Instrument store", 11, 2),
  ("A06", "My Other ATM", "ATM", NULL, 7),
  ("A07", "Malleus Malificarum Supplies", "Antiquarian books", 3, 3),
  ("A08", "Hammered Steel and Leather", "Custom iron-work fittings & clothes", 20, 1),
  ("A09", "Hammered Steel and Leather", "Custom iron-work fittings & clothes", 20, 1),
  ("A10", "Hammered Steel and Leather", "Custom iron-work fittings & clothes", 20, 1),
  ("A11", "Concertina Nation Super Store", "Instrument store", 2, 2),
  ("A12", "Concertina Nation Super Store", "Instrument store", 2, 2),
  ("A13", "Concertina Nation Super Store", "Instrument store", 2, 2),
  ("A14", "Concertina Nation Super Store", "Instrument store", 2, 2),
  ("A15", "Concertina Nation Super Store", "Instrument store", 2, 2),
  ("A16", "Nothing But Bagpipes!", "Instrument store", 27, 2),
  ("A17", "Nothing But Bagpipes!", "Instrument store", 27, 2),
  ("A18", "Nothing But Bagpipes!", "Instrument store", 27, 2),
  ("A19", "Digeridoo-wop Sound Stylists", "Instrument store", 29, 2),
  ("A20", "Digeridoo-wop Sound Stylists", "Instrument store", 29, 2),
  ("A21", "Digeridoo-wop Sound Stylists", "Instrument store", 29, 2),
  ("A22", "The Vinyl Antiquarian", "Old & current vinyl & tapes", 16, 6),
  ("A23", "The Vinyl Antiquarian", "Old & current vinyl & tapes", 16, 6),
  ("B26", "Patch the Bellows Fixer", "Instrument repair", 22, 4),
  ("B27", "Patch the Bellows Fixer", "Instrument repair", 22, 4),
  ("B28", "Patch the Bellows Fixer", "Instrument repair", 22, 4),
  ("B29", "Jim's DX Instrument Repair", "Instrument repair", 35, 4),
  ("B30", "Jim's DX Instrument Repair", "Instrument repair", 35, 4),
  ("B31", "Jim's DX Instrument Repair", "Instrument repair", 35, 4),
  ("B32", "Jim's DX Instrument Repair", "Instrument repair", 35, 4),
  ("B33", "Tattoos That Stay to Go", "Tattoos & piercings", 14, 5),
  ("B34", "Tattoos That Stay to Go", "Tattoos & piercings", 14, 5),
  ("B35", "Tattoos That Stay to Go", "Tattoos & piercings", 14, 5),
  ("A24", "Bob the CD Guy", "Old & current CDs & DVDs", 4, 6),
  ("A25", "Bob the CD Guy", "Old & current CDs & DVDs", 4, 6),
  ("B36", "Instruments You Never Knew Existed", "World music instruments", 38, 2),
  ("B37", "Instruments You Never Knew Existed", "World music instruments", 38, 2),
  ("B38", "Instruments You Never Knew Existed", "World music instruments", 38, 2),
  ("B39", "Jack in the Shruti Box", "World music instruments", 34, 2),
  ("B40", "The Future Isn't What it Used to Be", "Prepper supplies & literature", 18, 7),
  ("B41", "The Future Isn't What it Used to Be", "Prepper supplies & literature", 18, 7),
  ("B42", "The Future Isn't What it Used to Be", "Prepper supplies & literature", 18, 7),
  ("B43", "Little Gem Electronics Division", "Music, electronics, & repair", 31, 7),
  ("B44", "Little Gem Electronics Division", "Music, electronics, & repair", 31, 7),
  ("B45", "Little Gem Electronics Division", "Music, electronics, & repair", 31, 7),
  ...
  ("B50", "Footwear for the End of the World", "Custom footwear", 1, 1),
  ("B51", "Footwear for the End of the World", "Custom footwear", 1, 1),
  ("B52", "Footwear for the End of the World", "Custom footwear", 1, 1),
  ("B53", "Librus Umbrarum Rare Books", "Antiquarian books", 13, 3),
  ("B54", "Librus Umbrarum Rare Books", "Antiquarian books", 13, 3),
  ("B55", "Librus Umbrarum Rare Books", "Antiquarian books", 13, 3),
  ("B56", "Pavel and Jose's Taqueria", "Tacos and Borscht", 19, 8),
  ("B57", "Pavel and Jose's Taqueria", "Tacos and Borscht", 19, 8),
  ("B58", "Pavel and Jose's Taqueria", "Tacos and Borscht", 19, 8),
  ("B59", "Pavel and Jose's Taqueria", "Tacos and Borscht", 19, 8),
  ("B60", "The Cheating Vegan", "Omnivore fare, short order meals", 39, 8),
  ("B61", "The Cheating Vegan", "Omnivore fare, short order meals", 39, 8),
  ("B62", "The Cheating Vegan", "Omnivore fare, short order meals", 39, 8),
  ("B63", "Doom and Gloom!", "Prepper Supplies and Literature", 36, 7),
  ("B64", "Doom and Gloom!", "Prepper Supplies and Literature", 36, 7),
  ("B65", "Doom and Gloom!", "Prepper Supplies and Literature", 36, 7),
  ("B66", "Look the Part", "Custom Clothing", 37, 1), ("B67", "Look the Part", "Custom Clothing", 37, 1),
  ("B68", "Look the Part", "Custom Clothing", 37, 1), ("B69", "Look the Part", "Custom Clothing", 37, 1),
  ("B70", "Pampered Mutt", "Pet Supplies, Mutt Muffs", 40, 7),
  ("B71", "Pampered Mutt", "Pet Supplies, Mutt Muffs", 40, 7),
  ("B72", "The Unchained Spirit", "Custom Art, Watercolors, Stained Glass", 33, 7),
  ("B73", "The Unchained Spirit", "Custom Art, Watercolors, Stained Glass", 33, 7),
  ("B74", "Das Schnitzel Haus", "Sausage, Sandwiches, Snacks, Beer", 17, 8),
  ("B75", "Das Schnitzel Haus", "Sausage, Sandwiches, Snacks, Beer", 17, 8),
  ("B76", "Das Schnitzel Haus", "Sausage, Sandwiches, Snacks, Beer", 17, 8),
  ("B77", "Das Schnitzel Haus", "Sausage, Sandwiches, Snacks, Beer", 17, 8),
  ("B78", "Eine Kleine Knackwurst", "Sandwiches, Barbecue, Beer", 10, 8),
  ("B79", "Eine Kleine Knackwurst", "Sandwiches, Barbecue, Beer", 10, 8),
  ("B80", "Eine Kleine Knackwurst", "Sandwiches, Barbecue, Beer", 10, 8),
  ("B81", "Eine Kleine Knackwurst", "Sandwiches, Barbecue, Beer", 10, 8),
  ("B82", "Zur Krone West", "International Beer Hall", 23, 8),
  ("B83", "Zur Krone West", "International Beer Hall", 23, 8),
  ("B84", "Zur Krone West", "International Beer Hall", 23, 8),
  ("B85", "Zur Krone West", "International Beer Hall", 23, 8),
  ("B86", "Zur Krone West", "International Beer Hall", 23, 8),
  ("B87", "Just Like Late Night TV", "Misc. Goods 'As Advertised On TV'", 26, 7),
  ("B88", "Just Like Late Night TV", "Misc. Goods 'As Advertised On TV'", 26, 7),
  ("B89", "Just Like Late Night TV", "Misc. Goods 'As Advertised On TV'", 26, 7),
  ("B90", "Jimbo the Techie", "Tech Goodies and Repairs", 5, 4),
  ("B91", "Jimbo the Techie", "Tech Goodies and Repairs", 5, 4),
  ("B92", "Fried Stuff On Sticks", "Deep Fried Stuff on Sticks", 8, 8),
  ("B93", "Fried Stuff On Sticks", "Deep Fried Stuff on Sticks", 8, 8),
  ("B94", "Fried Stuff On Sticks", "Deep Fried Stuff on Sticks", 8, 8),
  ("B95", "Eat Cheese Or Die", "Cheese Curds, Beer, Pizza", 28, 8),
  ("B96", "Eat Cheese Or Die", "Cheese Curds, Beer, Pizza", 28, 8),
  ("B97", "Tour Collectibles", "Souvenirs of Music Tours", 15, 7),
  ("B98", "Tour Collectibles", "Souvenirs of Music Tours", 15, 7),
  ("B99", "The Convenient Shoppe", "Camping Supplies, Snacks, Toiletries", 21, 7),
  ("B100", "The Convenient Shoppe", "Camping Supplies, Snacks, Toiletries", 21, 7),
  ("B101", "The Convenient Shoppe", "Camping Supplies, Snacks, Toiletries", 21, 7),
  ("B102", "The Convenient Shoppe", "Camping Supplies, Snacks, Toiletries", 21, 7),
  ("B103", "My ATM", "ATM", NULL, 7),
  ("B104", "Kate's Kustom Keyboards", "Modifications & repair", 12, 4),
  ("B105", "The Portable Hangover", "Microbrew Beer Garden", 7, 8),
  ("B106", "The Portable Hangover", "Microbrew Beer Garden", 7, 8),
  ("B107", "The Portable Hangover", "Microbrew Beer Garden", 7, 8),
  ("B108", "A Cold One", "Ice Cream Shop", 30, 8), ("B109", "A Cold One", "Ice Cream Shop", 30, 8),
  ("B110", "A Cold One", "Ice Cream Shop", 30, 8), ("B111", "A Cold One", "Ice Cream Shop", 30, 8),
  ("B112", "Polished Wood and Custom Brass", "Custom Cabinetry and Fine Woodwork", 24, 7),
  ("B113", "Polished Wood and Custom Brass", "Custom Cabinetry and Fine Woodwork", 24, 7),
  ("B114", "Polished Wood and Custom Brass", "Custom Cabinetry and Fine Woodwork", 24, 7),
  ("B115", "The Metalsmith", "Hardware, Tools, Camping supplies", 9, 7),
  ("B116", "The Metalsmith", "Hardware, Tools, Camping supplies", 9, 7),
  ("B117", "The Metalsmith", "Hardware, Tools, Camping supplies", 9, 7),
  ("B118", "The Metalsmith", "Hardware, Tools, Camping supplies", 9, 7),
...
INSERT INTO TicketAssignment (TicketID, VisitorID, MerchID, DatePurchased, Paid, CheckedIn, LicensePlate, LicenseIssuedIn)
VALUES
  (1, 1, 49, "2017-06-01", TRUE, FALSE, NULL,
   NULL), /* Week-long adult ticket for visitor 1("Ivana","Knight"), two people staying for the week */
  ...
  (14, 4, 76, "2017-06-04", TRUE, FALSE, 'CH8 - M8',
   'California'), /* Day parking ticket for visitor 4("Emma","Horn") */
  (15, 4, 77, "2017-06-04", TRUE, FALSE, 'CH8 - M8', 'California');
/* Day parking ticket for visitor 4("Emma","Horn") */

INSERT INTO CampingAssignment (TicketID, CampingID)
VALUES (1, "A01"), (2, "A01"), (4, "A08"), (5, "A08"), (6, "A08"), (12, "C01"), (13, "C01");
